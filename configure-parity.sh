...
parity --geth --chain kovan --keys-path .parity/keys --force-ui --reseal-min-period 0 --jsonrpc-cors "*" --jsonrpc-apis web3,eth,net,parity,traces,rpc,personal --author ${address} --unlock ${address} --password .parity-pass
